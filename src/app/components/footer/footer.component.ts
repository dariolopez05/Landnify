      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div class="col-span-1 md:col-span-2">
            ...
            <div class="flex space-x-4">
              <a href="mailto:hola@landnify.com" class="text-gray-400 hover:text-violet-400 transition-colors duration-300">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                </svg>
              </a>
              <a href="tel:+34644663666" class="text-gray-400 hover:text-violet-400 transition-colors duration-300">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div class="flex space-x-6 mt-4 md:mt-0">
            ...
            <a routerLink="/politica-cookies" class="text-gray-500 hover:text-violet-400 text-sm transition-colors duration-300">
              Política de Cookies
            </a>
            <a routerLink="/aviso-legal" class="text-gray-500 hover:text-violet-400 text-sm transition-colors duration-300">
              Aviso Legal
            </a>
          </div>
        </div>
