...
@Component({
  ...
  template: `
    <div class="pt-20">
      ...
      <!-- Main Services -->
      <section class="py-20" #servicesSection>
      ...
      <!-- Automation Section -->
      <section class="py-20 bg-slate-900/50" #automationSection>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Maintenance Section -->
      <section class="py-20" #maintenanceSection>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center mb-16 animate-on-scroll">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">
      ...
      <!-- CTA Section -->
      <section class="py-20 bg-slate-900/50" #ctaSection>
